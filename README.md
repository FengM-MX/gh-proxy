...
- `PREFIX`是前缀，默认（根路径情况为"/gh"），如果自定义路由为example.com/gh/*，请将PREFIX改为 '/gh/'，注意，少一个杠都会错！
- 建议PREFIX通过UUID生成，防止非法访问，例如：**/gh/945b6cb6-0496-4cbd-a47e-b05c5de09e28/**，例如可以使用 https://www.lddgo.net/string/uuid 去生成自己的UUID
